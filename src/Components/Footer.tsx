...
function Footer() {
  ...
  <div className="container px-5 py-24 mx-auto mt-[40px]">
    ...
    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-pink-600 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">
            Sign-Up
          </button>
        </div>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4 ">
        <h2 className="title-font font-bold text-black tracking-widest text-lg mb-3 ml-3">
          CATEGORIES
        </h2>
  ...
  <div className="bg-white">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <Link 
      target='blank' href={"https://github.com"} className="text-gray-900 text-3xl">
      <FaGithub  />
      </Link>

      <Link
      target='blank' href={"https://vercel.com"} className="ml-3 text-gray-900 text-3xl">
      <IoLogoVercel  />
      </Link>
      
      <Link
      target='blank' href={"https://www.linkedin.com"} className="ml-3 text-gray-900 text-3xl">
        <FaLinkedin />
      </Link>
    </span>
    </div>
