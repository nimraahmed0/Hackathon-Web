...
const Leatestblog: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-center text-3xl font-bold font-serif text-blue-900 mb-8">Latest Blog</h1>
      <div className="grid items-center grid-cols-3 md:grid-cols-3 gap-8">
        {blogPosts.map((post) => (
          <div
            key={post.id}
